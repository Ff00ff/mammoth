...
export const extendDatabase = <State, Tables extends TableMap, D extends Database<any>>(tables: Tables, database: D): D & State => {
...
}>(tables: Tables): State & PoolDatabase<Tables> => {
